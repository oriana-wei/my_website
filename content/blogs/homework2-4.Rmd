...
We got the latest TfL data on how many bikes were hired every single day:
...
A facet grid plot of bikes hired by month and year will look like this:
...
Our code for the replicated graph:
...
The second one looks at percentage changes from the expected level of weekly rentals. The two grey shaded rectangles correspond to the second (weeks 14-26) and fourth (weeks 40-52) quarter:
